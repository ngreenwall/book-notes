...
- **2026-04-24** — **Shipped:** Repo layout for handoffs—handoff prompt (now [`.cursor/skills/handoff/SKILL.md`](../.cursor/skills/handoff/SKILL.md)); README **Continuing in a new chat**; session rubric here (≤10 entries, overflow → [`docs/archive/`](archive/)). Superseded April handoff-detail lives in [archive/context-2026-04.md](archive/context-2026-04.md). **Next:** none. **Blockers:** none.
